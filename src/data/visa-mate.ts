...
export const whatsappDisplayNumber = "";
export const phoneDisplayNumber = "";
export const contactEmail = "travecomobility@gmail.com";

export const whatsappMessage =
  "Hello TRAVECO Mobility, I would like assistance with my USA B1/B2 visa application.";
...
export const footerContent = {
  description:
    "TRAVECO Mobility provides visa documentation, application assistance and international travel support for individuals, families and business travellers.",
  address:
