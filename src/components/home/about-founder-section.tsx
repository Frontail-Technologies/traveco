      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="lg:w-[55%] xl:w-[60%]">
            ...
            <motion.div variants={fadeUp} className="text-(--traveco-primary,#0B1F3A)/80 text-[16px] md:text-[18px] leading-[1.7] flex flex-col gap-6 mb-12">
              <p>
            ...
            <motion.div variants={fadeUp} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-4 py-8 border-y border-(--traveco-primary)/10 mb-10">
