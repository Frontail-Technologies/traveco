...
const navbarNavigationItems = [
  ...
  { 
    ...
    subItems: [
      ...
      { label: "All Visa Categories", href: "/visa-services" },
    ]
  },
          ...
          {navbarNavigationItems.map((link) => {
              ...
              return (
                ...
                >
                  <Link
                    href={link.href}
                    className={cn(
                      "flex items-center gap-1 text-[13px] xl:text-[13.5px] font-medium transition-colors hover:text-accent relative py-6",
            ...
            return (
              <Link
                ...
                href={link.href}
                className={cn(
                  "text-[13px] xl:text-[13.5px] font-medium transition-colors hover:text-accent relative",
