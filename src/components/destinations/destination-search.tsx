  ...
  return (
    <div ref={wrapperRef} className="relative w-full max-w-150">
      ...
      >
        ...
        <div 
          className={cn(
            "flex items-center w-full h-14 bg-white border rounded-[12px] px-5 shadow-sm transition-all relative z-10",
            open ? "border-() ring-1 ring-()" : "border-slate-200 hover:border-slate-300"
          )}
        >
          <CommandPrimitive.Input
            ...
            className="flex-1 min-w-0 text-[16px] border-0 outline-none bg-transparent placeholder:text-slate-400 text-() focus:ring-0"
          />
        ...
        {open && (
          <div
            className="absolute left-0 right-0 top-[calc(100%+8px)] z-50 bg-white border border-slate-200 rounded-[12px] shadow-xl overflow-hidden"
          >
                ...
                .map((dest) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col min-w-0">
                      <span className="text-[14.5px] font-medium text-() truncate">
                        <HighlightMatch text={dest.country} query={query} />
                      </span>
                      <span className="text-[12px] text-()/60 truncate max-w-[320px]">
