  ...
  return (
    <aside className="hidden lg:block w-55 shrink-0">
      <div className="sticky top-28">
        <p className="text-[10px] font-bold tracking-widest text-(--traveco-primary)/50 uppercase mb-5">
          On This Page
        </p>
            ...
            return (
              <a
                ...
                className={cn(
                  ...
                  isActive ? 'bg-white text-navy' : 'hover:bg-white/60 text-(--traveco-primary)/60 hover:text-navy',
                )}
              >
                <span
                  className={cn(
                    'text-[11px] font-bold w-4 shrink-0 transition-colors',
                    isActive ? 'text-navy' : 'text-(--traveco-primary)/30',
                  )}
                >
                  {i + 1}.
                </span>
