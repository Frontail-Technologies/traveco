...
export default function VisaServicesHub() {
  return (
    <div className="bg-background pt-22">
        ...
        <div className="mx-auto max-w-340 px-5 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            <div className="lg:w-[50%]">
              ...
              <h1 className="text-[40px] md:text-[50px] lg:text-[60px] font-medium text-navy leading-[1.05] tracking-tight mb-6" data-scroll="fade-up">
                Visa assistance for every kind of journey.
              </h1>
              <p className="text-(--traveco-primary)/70 text-[16px] md:text-[18px] leading-[1.7] max-w-xl" data-scroll="fade-up">
      ...
      <section className="py-20 md:py-28 lg:py-32 border-t border-(--traveco-primary)/5">
        <div className="mx-auto max-w-340 px-5 sm:px-6 lg:px-8">
              ...
              return (
                <div key={service.id} className="flex flex-col group">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <span className="text-(--traveco-primary)/30 font-medium text-[14px]">
                      0{index + 1}
                    </span>
                    <div className="w-10 h-px bg-(--traveco-primary)/10" />
                  </div>

                  <div className="flex items-start gap-5">
                    <div className="w-12 h-12 rounded-[12px] bg-white border border-(--traveco-primary)/10 flex items-center justify-center shrink-0 shadow-sm group-hover:border-accent transition-colors">
                      <Icon className="w-5 h-5 text-navy" />
                    </div>
                    <div>
                      <h3 className="text-[22px] md:text-[26px] font-medium text-navy mb-4">
                        {service.title}
                      </h3>
                      <p className="text-(--traveco-primary)/70 text-[15px] leading-[1.65] mb-6">
                        {service.description}
                      </p>
                      <Link
                        href={`/visa-services/${service.slug}`}
                        className="inline-flex items-center text-[14px] font-bold text-navy hover:text-accent transition-colors"
                      >
      ...
      <div className="pb-16 md:pb-24 pt-8 bg-background">
        <PreFooterCTA
