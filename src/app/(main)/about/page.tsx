    ...
    <div className="bg-[#F7F5EF] pt-22">
      ...
      <section className="relative w-full overflow-hidden bg-[#0B1F3A] py-16 md:py-24 lg:py-32">
        <div className="mx-auto flex max-w-340 flex-col lg:flex-row items-center gap-12 lg:gap-16 px-5 sm:px-6 lg:px-8">
          ...
          {/* 2. HERO IMAGE */}
          <div className="lg:w-[45%] xl:w-[40%] order-1 lg:order-2 w-full max-w-125 lg:max-w-none mx-auto relative z-10">
      ...
      <section className="py-20 md:py-28 lg:py-32 bg-[#F7F5EF]">
        <div className="mx-auto max-w-340 px-5 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-12">
            <h2 className="text-[32px] md:text-[38px] font-medium text-(--traveco-navy,#0B1F3A) tracking-tight">
              Experience across major global visa systems.
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="border-t border-(--traveco-navy)/10 pt-6">
              <h4 className="text-[18px] font-bold text-traveco-navy mb-6">Major Destinations</h4>
            ...
            <div className="border-t border-(--traveco-navy)/10 pt-6">
              <h4 className="text-[18px] font-bold text-traveco-navy mb-6">Wider Coverage</h4>
              <ul className="flex flex-col gap-3">
            ...
            <div className="border-t border-(--traveco-navy)/10 pt-6">
              <h4 className="text-[18px] font-bold text-traveco-navy mb-6">Operational Experience</h4>
              <ul className="flex flex-col gap-3">
      ...
      <section className="bg-white pt-20 pb-16 md:pt-28 md:pb-20 lg:pt-32 lg:pb-24">
        <div className="mx-auto max-w-340 px-5 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-[32px] md:text-[42px] font-medium text-(--traveco-navy,#0B1F3A) tracking-tight">
        ...
        <div className="mx-auto max-w-340 bg-[#0B1F3A] rounded-[20px] p-8 md:p-12 lg:p-16 text-white flex flex-col lg:flex-row lg:items-center justify-between gap-10 shadow-sm">
          ...
          <div className="lg:w-[40%] flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-4 lg:justify-end shrink-0">
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-white/10 hover:bg-white/20 text-white transition-colors rounded-[10px] h-13 px-8 font-bold text-[15px] whitespace-nowrap"
            >
              Chat on WhatsApp →
            </a>
          </div>
