            ...
            <div className="lg:w-[58%]">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4 my-8">
                <div className="rounded-2xl sm:rounded-[1.5rem] bg-white p-2.5 sm:p-4 md:p-5 border border-navy/15 text-center md:text-left shadow-xs transition-all duration-300 hover:border-accent/40 hover:shadow-sm">
                  <span className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-navy leading-none block mb-1.5">
                    <AnimatedCounter value={8} suffix="+" duration={1.5} />
                  </span>
                  <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-muted-foreground">Years Exp.</span>
                </div>
                <div className="rounded-2xl sm:rounded-[1.5rem] bg-white p-2.5 sm:p-4 md:p-5 border border-navy/15 text-center md:text-left shadow-xs transition-all duration-300 hover:border-accent/40 hover:shadow-sm">
                  <span className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-navy leading-none block mb-1.5">
                    <AnimatedCounter value={100} suffix="+" duration={2} />
                  </span>
                  <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-muted-foreground">Countries</span>
                </div>
                <div className="rounded-2xl sm:rounded-[1.5rem] bg-white p-2.5 sm:p-4 md:p-5 border border-navy/15 text-center md:text-left shadow-xs transition-all duration-300 hover:border-accent/40 hover:shadow-sm">
                  <span className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-navy leading-none block mb-1.5">
                    <AnimatedCounter value={10000} suffix="+" duration={2.2} formatThousands />
                  </span>
                  <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-muted-foreground">Applications</span>
                </div>
              </div>
            </div>
          </div>
